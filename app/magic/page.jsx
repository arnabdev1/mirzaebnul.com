      ...
      <div className="container mx-auto">
        <div className="flex flex-col xl:flex-row gap-[30px] justify-center items-center">
          <div className="xl:w-[54%] order-2 xl:order-none">
            ...
            >
              <h3 className="text-4xl text-secondary">See the magic!</h3>
              ...
              <div className="flex flex-col gap-1">
                ...
                <Input
                  ...
                  className="input max-w-100 bg-secondary rounded-md text-black py-2"
                />
              </div>
              ...
              <div className="flex justify-center items-center">
                <button
                  ...
                  src="/"
                  size="md"
                  className="transition-all duration-300 p-5 rounded-full text-lg border-white border-2 hover:border-0 font-light text-white bg-transparent hover:text-xl hover:bg-secondary hover:text-black active:bg-secondary focus:outline-none focus:text-white active:text-black focus:ring focus:ring-[#ffffff]"
                  id="submitButton"
                >
                  Submit
                </button>
              ...
              {info.map((item, index) => {
                return (
                  <li key={index} className="flex items-center gap-6">
                    <div className="w-[52px] h-[52px] xl:w-[72px] xl:h-[72px] bg-[#27272c] text-secondary rounded-md flex items-center justify-center">
